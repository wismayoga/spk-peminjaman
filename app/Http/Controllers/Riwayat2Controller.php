...
class Riwayat2Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        //     ->select("penilaians.*", 'tabel_alternatif.nama as nama_alternatif', 'tabel_alternatif.alamat as alamat')
        //     ->get();
        ...
        foreach ($penilaians as $penilaian) {
            ...
            $result2 = [
                'linguistik_rk' => $perhitungan['linguistik_rk'],
                'linguistik_penghasilan' => $perhitungan['linguistik_penghasilan'],
                'linguistik_tanggungan' => $perhitungan['linguistik_tanggungan'],
                'linguistik_jaminan' => $perhitungan['linguistik_jaminan'],
            ];
        ...
        return view('dashboard.riwayat2', [
