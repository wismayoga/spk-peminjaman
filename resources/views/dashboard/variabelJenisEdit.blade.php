            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="page-description">
                            <h1>Edit Data Jenis Variabel</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <form class="py-2 needs-validation" action="{{ route('jenisVariabel.update', $jenisVariabel->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Masukan nama variabel..." class="form-control"
                                            id="nama" aria-describedby="nama" name="nama" value="{{ old('variabel', $jenisVariabel->nama) }}" required>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select" id="variabel" name="variabel" required>
                                            <option value="{{ old('variabel', $jenisVariabel->id_variabel) }}" selected>{{ $jenisVariabel->nama_variabel }}</option>
                                            @foreach ($variabels as $variabel)
                                                @if ($variabel->id !== $jenisVariabel->id_variabel)
