                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="card widget widget-stats">
                            <div class="card-body">
                                <a href="{{ route('variabel.index') }}" class="text-decoration-none">
                                    <div class="widget-stats-container d-flex">
                                        ...
                                        <div class="widget-stats-content mt-2">
                                            <span class="widget-stats-amount">Data Variabel</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card widget widget-stats">
                            <div class="card-body">
                                <a href="{{ route('himpunan.index') }}" class="text-decoration-none">
                                    <div class="widget-stats-container d-flex">
                                        ...
                                        <div class="widget-stats-content mt-2">
                                            <span class="widget-stats-amount">Himpunan Fuzzy</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card widget widget-stats">
                            <div class="card-body">
                                <a href="{{ route('aturan.index') }}" class="text-decoration-none">
                                    <div class="widget-stats-container d-flex">
                                        ...
                                        <div class="widget-stats-content mt-2">
                                            <span class="widget-stats-amount">Data Aturan</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
