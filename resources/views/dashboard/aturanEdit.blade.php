            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <form class="py-2 needs-validation" action="{{ route('aturan.update', $aturan->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-12">
                                            ...
                                            <select class="form-select" id="rk" name="rk" required>
                                                <option value="{{ $aturan->id_rk }}" selected>{{ $aturan->rk_nama }}
                                                </option>
                                                @foreach ($rk as $rk)
                                        ...
                                        <div class="col-md-2 col-12">
                                            ...
                                            <select class="form-select" id="penghasilan" name="penghasilan" required>
                                                <option value="{{ $aturan->id_penghasilan }}" selected>
                                                    {{ $aturan->penghasilan_nama }}</option>
                                        ...
                                        <div class="col-md-2 col-12">
                                            ...
                                            <select class="form-select" id="tanggungan" name="tanggungan" required>
                                                <option value="{{ $aturan->id_tanggungan }}" selected>
                                                    {{ $aturan->tanggungan_nama }}</option>
                                        ...
                                        <div class="col-md-2 col-12">
                                            ...
                                            <select class="form-select" id="jaminan" name="jaminan" required>
                                                <option value="{{ $aturan->id_jaminan }}" selected>
                                                    {{ $aturan->jaminan_nama }}</option>
                                        ...
                                        <div class="col-md-2 col-12">
                                            ...
                                            <input type="number" placeholder="Masukan 0 atau 1" class="form-control"
                                                id="hasil" aria-describedby="hasil" name="hasil"
                                                value="{{ $aturan->hasil }}" required>
                                            <div class="invalid-feedback">
                                                Masukan 0 atau 1
                                            </div>
                                        </div>
            ...
            Array.from(forms).forEach(function(form) {
                form.addEventListener('submit', function(event) {
                    ...
                    dropdowns.forEach(function(dropdown) {
                        if (dropdown.value === "--Pilih Riwayat--" || dropdown.value ===
                            "--Pilih Penghasilan--" || dropdown.value ===
                            "--Pilih Tanggungan--" || dropdown.value === "--Pilih Jaminan--") {
                            isValid = false;
                    ...
                    if (!/^[01]$/.test(thenInput.value)) {
                        isValid = false;
                        thenInput.setCustomValidity('Masukkan nilai 0 atau 1');
                    } else {
